...
nombres_col <- c("Entidad",
                 ...
                 "PARTICULAR",
                 "DGBETD",
                 "CENTRO BACHILLERATO DESARROLLO COMUNITARIO",
                 "CETI",
                 "COL BACHILLERES",
...
colores_extendidos <- mi_paleta(20)
print(colores_extendidos)
barplot(rep(1, 20), col = colores_extendidos,
        border = NA, main = "Paleta de colores personalizada")
# Cargar la librería grDevices para trabajar con colores
##---- ALTERNATIVAMENTE ----
...
for (i in 1:nrow(data)) {
  ...
  df_plot <- data.frame(
    Subsistema = names(valores),
    Cantidad = as.numeric(valores)
  )
  
  # Asignar colores de la paleta extendida al gráfico
  ...
  # Guardar gráfico en un archivo PDF en la carpeta de salida
...
##---- MODIFICANDO PARA GRAFICAR SUBSISTEMAS CON VALORES DISTINTOS DE CERO ----
# Cargar los datos
data <- read.csv("Repositorios/Municipios_Categoria1_Subsistemas.csv")
setwd("~/Documents/MacroReportes")
output_dir <- "~/Documents/MacroReportes/Graficos_Cat1"
